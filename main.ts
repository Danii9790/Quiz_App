  ...
  if (choices.select === "Registration") {
    ...
    const Typescript = await inquirer.prompt([
      ...
      },
      {
        ...
        type: "list",
        message:
          "Which keyword is used to define a variable in TypeScript that cannot be reassigned?",
      ...
      },
      {
        ...
        type: "list",
        message:
          "What does the (interface) keyword allow you to do in TypeScript?",
        choices: [
      ...
      },
      {
        ...
        type: "list",
        message:
          "Which of the following is an example of a TypeScript data type?",
      ...
      },
      {
        ...
        type: "list",
        message:
          "What is the comparative form of the adjective (good) in TypeScript?",
        choices: ["a) Well", "b) Best", "c) Better", "d) Gooder"], //Better
      },
    ]);
    // Quiz Answers:
    ...
    for (let admitCard of storeData) {
      ...
      console.log(
        chalk.bold.greenBright("Roll No: ") +
          chalk.bold.yellowBright(admitCard.rollNo)
      );
      console.log(
        chalk.bold.greenBright("Course: ") +
          chalk.bold.yellowBright(admitCard.course)
      );
      console.log(
        chalk.bold.greenBright("Timing: ") +
      ...
      if (searchResult.student == student.rollNo) {
        ...
        if (pushScore[storeData.indexOf(student)] < 5) {
          ...
          console.log(
            chalk.bold.redBright(
              `                            Your Total Score is ${
                pushScore[storeData.indexOf(student)]
              }/10`
            )
          );
        } else {
